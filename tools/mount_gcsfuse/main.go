...
func makeGcsfuseArgs(
	...
	for name, value := range opts {
		...
		case "dir_mode", "file_mode", "key_file", "temp_dir", "gid", "uid", "only_dir", "limit_ops_per_sec", "limit_bytes_per_sec", "stat_cache_ttl", "type_cache_ttl", "debug_fuse", "debug_gcs", "debug_http":
			args = append(
				args,
				"--"+strings.Replace(name, "_", "-", -1),
				value,
